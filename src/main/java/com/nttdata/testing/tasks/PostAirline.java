...
public class PostAirline implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Post.to("/airlines").with(requestSpecification -> requestSpecification.contentType(ContentType.JSON).body("{\"_id\":\"" + _id + "\"," + "\"name\":\"" + name + "\"," + "\"country\":\"" + country + "\"," + "\"logo\":\"" + logo + "\"," + "\"slogan\":\"" + slogan + "\"," + "\"head_quaters\":\"" + head_quaters + "\"," + "\"website\":\"" + website + "\"," + "\"established\":\"" + established + "\"}").log().all()));
    }
}